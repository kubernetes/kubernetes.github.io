...
* See {{< api-reference page="config-and-storage-resources/secret-v1" >}}.
* See the `imagePullSecrets` field of {{< api-reference page="workload-resources/pod-v1" anchor="PodSpec" >}}.
